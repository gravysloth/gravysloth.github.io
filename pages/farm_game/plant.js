class Plant extends Thing {
  ...
  update() {
    ...
    if (this.newFruitTimer <= 0 && this.isGrowingNewFruit) {
      this.isGrowingNewFruit = false;
      this.newFruitTimer = random(0 * secondsToMs, 3 * secondsToMs);
      let newFruit = CreateThing(
        new this.FruitClass(
          random(-1 * this.fruitAreaRadius, this.fruitAreaRadius),
          random(-1 * this.fruitAreaRadius, this.fruitAreaRadius),
          this,
          this.fruits.length
        )
...
class Bush extends Plant {
  constructor(x, y) {
    super(
      x,
      y,
      [loadImage("imgs/bush1.png"), loadImage("imgs/bush2.png")],
      Berry,
      30
    );
    this.animSpeed = 0;
...
class Berry extends Fruit {
  constructor(x, y, plant) {
    super(
      x,
      y,
      [loadImage("imgs/berry1.png"), loadImage("imgs/berry2.png")],
      plant
    );
    this.name = "Berry";
